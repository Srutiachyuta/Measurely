    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-11 h-11 rounded-2xl bg-primary-600 text-white shadow-lg shadow-primary-500/25 hover:bg-primary-700 hover:shadow-xl hover:shadow-primary-500/30 active:scale-95 transition-all duration-200"
